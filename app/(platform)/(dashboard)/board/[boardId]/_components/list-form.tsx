      ...
      <ListWrapper>
        ...
        >
          ...
          <div className='flex items-center gap-x-1'>
            <FormSubmit className='hover:cursor-pointer'>Add list</FormSubmit>
            <Button
  ...
  return (
    <ListWrapper>
      <button
        ...
        className='flex w-full items-center rounded-md bg-white/80 p-3 text-sm font-medium transition hover:cursor-pointer hover:bg-white/50 dark:bg-white/10 dark:hover:bg-white/5'
      >
